...
$ docker run -v /path/to/default.vcl:/etc/varnish/default.vcl:ro --tmpfs /var/lib/varnish/varnishd:exec mips64le/varnish
```
...
```console
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G mips64le/varnish
```
...
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G mips64le/varnish -p default_keep=300
```
