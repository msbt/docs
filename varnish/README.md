...
$ docker run -v /path/to/default.vcl:/etc/varnish/default.vcl:ro --tmpfs /var/lib/varnish/varnishd:exec arm64v8/varnish
```
...
```console
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G arm64v8/varnish
```
...
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G arm64v8/varnish -p default_keep=300
```
