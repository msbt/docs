...
$ docker run -v /path/to/default.vcl:/etc/varnish/default.vcl:ro --tmpfs /var/lib/varnish/varnishd:exec arm32v6/varnish
```
...
```console
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G arm32v6/varnish
```
...
$ docker run --tmpfs /var/lib/varnish/varnishd:exec -e VARNISH_SIZE=2G arm32v6/varnish -p default_keep=300
```
